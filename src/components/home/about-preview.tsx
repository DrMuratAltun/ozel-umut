        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">
              Umut ile Baslar, Basariyla Devam Eder
            </h2>
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Umut Ozel Egitim ve Rehabilitasyon Merkezi olarak, ozel gereksinimli bireylerin
              egitim ve rehabilitasyon ihtiyaclarini karsilamak amaciyla Korkuteli&apos;de hizmet
              vermekteyiz. Uzman kadromuz, modern yaklasimlar ve bireysel egitim planlariyla her
              ogrencimizin potansiyelini en ust duzeye cikarmak icin calisiyoruz.
            </p>
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Sefkatli yaklasim</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10 text-primary">
                ...
                <div>
                  <p className="font-semibold text-foreground">Guven</p>
          ...
          <div className="relative">
            <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-primary/20 via-teal-light to-amber-light flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <p className="mt-2 text-lg font-medium text-foreground">Umut Ozel Egitim</p>
