      ...
      <Card><CardContent className="p-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div><Label htmlFor="iconName">Ikon Adi</Label><Input id="iconName" name="iconName" placeholder="BookOpen" className="mt-1.5" /></div>
            <div><Label htmlFor="imageUrl">Gorsel URL</Label><Input id="imageUrl" name="imageUrl" type="url" className="mt-1.5" /></div>
