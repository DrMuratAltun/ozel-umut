      ...
      <Card><CardContent className="p-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div><Label htmlFor="targetGroup">Hedef Grup</Label><Input id="targetGroup" name="targetGroup" placeholder="3-18 Yaş" className="mt-1.5" /></div>
          </div>
          ...
          <div><Label htmlFor="features">Özellikler (virgülle ayırın)</Label><Input id="features" name="features" placeholder="Bireysel eğitim, Sosyal beceri, Motor gelişim" className="mt-1.5" /></div>
          <div><Label htmlFor="sortOrder">Sıralama</Label><Input id="sortOrder" name="sortOrder" type="number" defaultValue="0" className="mt-1.5 w-32" /></div>
