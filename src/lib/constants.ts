export const SITE_NAME = "Umut Ozel Egitim ve Rehabilitasyon Merkezi";
export const SITE_DESCRIPTION =
  "Korkuteli'de ozel egitim, dil ve konusma terapisi, fizyoterapi ve psikolojik danismanlik hizmetleri sunan profesyonel rehabilitasyon merkezi.";
